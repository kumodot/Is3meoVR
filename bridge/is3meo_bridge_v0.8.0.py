...
DEFAULTS = {
    ...
    'sender_url': 'https://kumodot.github.io/Is3meoVR/stream_sender/stream_sender_v0.7.0.html',
...
async def run(cfg):
    ...
    async with async_playwright() as pw:
        ...
        def save_config(new):
            try:
                allowed = ['code', 'capture_source', 'audio_device', 'bitrate', 'browser', 'apps', 'auto_open_app', 'speaker_mute']
                for k in allowed:
                    if k in new:
                        cfg[k] = new[k]
                code = str(cfg.get('code') or '')
