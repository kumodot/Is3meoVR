@echo off
REM Light Spill Lab launcher - v0.8.0
...
REM   then open http://localhost:8080/light_spill_lab_v0.8.0.html in the Quest Browser
cd /d "%~dp0"
set FILE=light_spill_lab_v0.8.0.html
