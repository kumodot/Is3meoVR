@echo off
REM Light Spill Lab launcher - v0.7.0
...
REM   then open http://localhost:8080/light_spill_lab_v0.7.0.html in the Quest Browser
cd /d "%~dp0"
set FILE=light_spill_lab_v0.7.0.html
